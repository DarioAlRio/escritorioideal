...
const ARTICLES = [
  ...
  },
  {
    ...
    body: [
      ...
      "Si notas dolor en la zona lumbar, en las rodillas o en los pies al estar de pie, es una señal de que algo del ajuste no está bien —altura de la mesa, calzado, tiempo excesivo de golpe— y conviene revisarlo, no forzar el hábito por sistema.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "Un detalle menor pero real: con la calefacción encendida, el ambiente se seca más, lo que puede acentuar la fatiga ocular si ya tenías cierta tendencia a el ojo seco frente a la pantalla. No es un problema del escritorio en sí, pero conviene tenerlo en cuenta si notas más molestia visual de la habitual al empezar la temporada.",
    ],
  },
  {
    ...
    body: [
      ...
      "2. Espalda baja apoyada. Con la espalda pegada al respaldo, comprueba si la zona lumbar queda apoyada o flota en el aire. Si flota, un cojín lumbar pequeño puede ser un parche razonable mientras decides si necesitas otra silla.",
      "3. Altura del monitor. Mirando al frente, sin bajar ni subir la barbilla, el borde superior del monitor debería quedar a la altura de tus ojos o justo por debajo. Si tienes que inclinar la cabeza hacia arriba, prueba a elevarlo con un soporte o unos libros antes de pensar en comprar uno nuevo.",
